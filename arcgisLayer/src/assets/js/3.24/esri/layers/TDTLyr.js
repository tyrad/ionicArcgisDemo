...
return declare(esri.layers.TiledMapServiceLayer, {
        ...
        getTileUrl: function(level, row, col) {
          ...
          //天地图*临沂 注记层
          // return "http://t0.tianditu.com/cva_c/wmts?service=WMTS&request=gettile&layer=cva&style=Default&tileMatrixSet=c"+"&TileMatrix="+ level +"&version=1.0.0&TileRow="+ row + "&TileCol="+ col +"&format=tiles";
          //天地图*临沂 矢量层
          // return  "http://t0.tianditu.com/vec_c/wmts?service=WMTS&request=gettile&layer=vec&style=Default&tileMatrixSet=c"+"&TileMatrix="+ level +"&version=1.0.0&TileRow="+ row + "&TileCol="+ col +"&format=tiles";
         }
      });
      });