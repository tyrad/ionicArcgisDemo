...
return declare(esri.layers.TiledMapServiceLayer, {
        ...
        getTileUrl: function(level, row, col) {
             ...
             return  "http://www.sdmap.gov.cn/tileservice/SDRasterPubMapDJ?SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile" + "&LAYER=0" + "&STYLE=default" + "&FORMAT=image/png" + "&TILEMATRIXSET=taishannew" + "&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col;
